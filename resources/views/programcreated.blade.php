                ...
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <div class="row">
                        ...
                        <div style="text-align:center;margin-top: 30px">
                            <p style="margin-bottom:10px;margin-left:20px;font-size: 14px; color: #5d4ca7; font-weight: bold; vertical-align: bottom"><b>fithabit.io/{{$link}}</b></p>
                            <a href="#" style="color: black"><p style="margin-bottom:20px;margin-left:20px;font-size: 15px; font-weight: bold; vertical-align: bottom"><b>Copy</b></p></a>
                        </div>
