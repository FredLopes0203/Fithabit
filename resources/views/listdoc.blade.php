    ...
    <div class="dashboardBackground">
        <div class="dashboardContent">
            <div><!--header-->
                ...
                <div class="infodoceditor" id="textdiv" name="textdiv" style="background-color: #faf2e7; padding: 20px;">
                ...
                <div style="text-align: center; margin-bottom: 20px; margin-top: 20px">
                    <form action="{{url($nexturl)}}" method="POST">
                        {!! csrf_field() !!}
                        <input type="hidden" name="publishable" id="publishable" class="form-control" value="yes"/>
