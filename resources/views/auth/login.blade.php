                    ...
                    <div class="col-sm-4">
                        <div class="login-form"><!--login form-->
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <span>
                                    <input name="remember" id="remember" type="checkbox" class="checkbox" autocomplete="off" {{ old('remember') ? 'checked' : '' }}>
                                    Keep me signed in
                                </span>
                                ...
                                <div class="row" style="float: left; margin-left:0px; margin-right: 0px">
                                @if ($errors->has('email'))
