    ...
    <section id="loginform"><!--form-->
        <div class="container">
            <div class="row center">
                <div class="col-sm-6" >
                    ...
                    <img src="{{asset('images/home/ptregister/ptregister1.png')}}" class="program img-responsive" alt="" />
                </div>
                <div class="col-sm-4  col-sm-offset-1">
                    <h2 class="customH2">Personal Trainer Register</h2>
        ...
        <div class="step1">
            <div class="container">
                ...
                <h4>Not only does FitHabit manage your products and clients, but we manage your payments too.</h4>
            ...
            <div class="container">
                ...
                <div class="row center">
                    ...
                    <div class="col-sm-5" >
                        ...
                        <h4>That's it. Fithabit believes in keeping it <br> simple and letting you keep more money <br>from the product you created.</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="morefeature col-sm-6" >
                    <div class="featurerightpane">
                        <div class="row center">
                            <div class="col-sm-4">
                                <img src="{{asset('images/home/ptregister/ptregister1.png')}}" class="featureimg img-circle"/>
                            </div>
                            <div class="col-sm-8">
                                <h4>Welcome This is new feature<br>You can learn more here.</h4>
                                <h4>This is new feature<br>You can learn more here.</h4>
                            </div>
                        </div>
                        <div class="row center">
                            <div class="col-sm-4">
        ...
        <div class="step4">
            <div class="container">
                ...
                <h1><strong>Just $00/month</strong></h1>
                <h4>or save 30% and pay just $000 for a year</h4>
