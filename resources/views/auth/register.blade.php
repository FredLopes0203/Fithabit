                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="signup-form"><!--sign up form-->
                            ...
                            <div style="vertical-align: middle">
                                ...
                                <button type="submit" style="float:right;margin-left: 20px; margin-top: 15px" class="btn btn-hot text-uppercase btn-md" onclick="window.location='{{ url("register/pt") }}'">Sign Up as PT</button>
                            </div>
